...
async def create_user(collection: AsyncIOMotorCollection, user: UserIn) -> int:
...
async def update_user(collection: AsyncIOMotorCollection, id: int, user: UserIn) -> bool:
